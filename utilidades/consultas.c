void buscar_eventos(){
    ...
    while(opc!=3){
        system("cls");
        printf("1.Buscar por rango de temperatura\n2.Buscar por fecha\n3.Salir\nINGRESE UNA OPCION: ");
        scanf("%d",&opc);
        switch (opc)
        {
        case 1: 
            ...
            int min,max;
            system("cls");
            printf("Buscar por rango de temperatura\n");
            printf("Temperatura minima: "); scanf("%d",&min);
            printf("Temperatura maxima: "); scanf("%d",&max);
            system("cls");
